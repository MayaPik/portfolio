  ...
  return (
    <section id="contact" className="relative">
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-1/2 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-5 flex items-center justify-start relative">
        ...
        >
          ...
          <div className="relative mb-4">
            <label
              htmlFor="name"
              className="leading-7 text-lg text-green-200 mb-4"
            >
              Name
            </label>
            <input
